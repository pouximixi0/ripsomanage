...
title Ripsodebloat - Un outils de Ripsomanage qui enlève les bloatwares de ton Windows.

cls & echo ======================
echo Application des paramètres Windows 11
echo ====================== & echo.
...
echo.
echo ======================
echo Modification de la barre des tâches et du menu Démarrer. Attendez svp...
echo ====================== & echo.
...
echo ======================
echo Installation de winget. Attendez svp...
echo ====================== & echo.
...
cls & echo ======================
echo Supprimer les packages. Attendez svp...
echo ====================== & echo.
